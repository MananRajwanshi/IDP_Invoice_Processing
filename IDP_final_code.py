...
def show_home_page():
    ...
    with col1:
        ...
        *🌍 Multilingual Support*
        - Process documents in 10 languages
...
def show_ocr_page():
    ...
    if uploaded_files:
        ...
        if st.button("🚀 Process", type="primary"):
            ...
            for file_idx, file in enumerate(uploaded_files):
                ...
                try:
                    ...
                    if texts:
                        ...
                        st.warning(f"⚠ No text detected in {file.name}")
            ...
            st.balloons()
    # [Include all your existing OCR processing code here]
    # Copy the entire OCR processing logic from your original code
...
<div style='text-align: center; color: #666; padding: 20px;'>
    <p>📄 InvoiceInsight PRO | Powered by Advanced OCR & AI Technology</p>
</div>
""", unsafe_allow_html=True)    